        ...
        if ($isTeamManager) {
            ...
            $this->addMenuItem([
                ...
                'children' => [
                    ...
                    [
                        'label' => __('Players'),
                        'route' => route('team-manager.players'),
                        'active' => Route::is('team-manager.players'),
                        'priority' => 12,
                        'permissions' => 'actual-team.view',
                    ],
                    [
                        'label' => __('My Squad'),
                        'route' => route('team-manager.squad'),
                        'active' => Route::is('team-manager.squad'),
                        'priority' => 14,
                        'permissions' => 'actual-team.view',
                    ],
                    [
                        'label' => __('Other Teams'),
                        'route' => route('team-manager.other-teams'),
                        'active' => Route::is('team-manager.other-teams') || Route::is('team-manager.other-teams.*'),
                        'priority' => 16,
                        'permissions' => 'actual-team.view',
                    ],
                    [
                        'label' => __('Wishlist'),
                        'route' => route('team-manager.wishlist'),
                        'active' => Route::is('team-manager.wishlist'),
                        'priority' => 18,
                        'permissions' => 'actual-team.view',
                    ],
                    ...($user->player ? [[
