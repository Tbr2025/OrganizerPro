...
{
    use HasFactory;
    protected $fillable = ['auction_id', 'player_id', 'organization_id', 'team_id', 'base_price', 'retained_price', 'status', 'current_price', 'current_bid_team_id', 'sold_to_team_id', 'final_price', 'player_status'];
