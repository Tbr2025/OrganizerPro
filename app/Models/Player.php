...
class Player extends Model implements MustVerifyEmail
{
    ...
    protected $casts = [
        ...
        'verified_travel_date_from' => 'boolean',
        'verified_travel_date_to' => 'boolean',
        'verified_location_id' => 'boolean',
        'verified_total_matches' => 'boolean',
        'verified_total_runs' => 'boolean',
        'verified_total_wickets' => 'boolean',
