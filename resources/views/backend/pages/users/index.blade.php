                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5 flex flex-col md:flex-row justify-between items-center gap-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center justify-center">
                                ...
                                <!-- Dropdown menu -->
                                <div id="roleDropdown"
                                    class="z-10 hidden w-56 p-3 bg-white rounded-md shadow dark:bg-gray-700">
                                    <ul class="space-y-2">
                        ...
                        <table id="dataTable" class="w-full dark:text-gray-300">
                            <thead class="bg-light text-capitalize">
                                <tr class="border-b border-gray-100 dark:border-gray-800">
                                    ...
                                    <th width="20%"
                                        class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5">
                                        <div class="flex items-center">
                                            {{ __('Name') }}
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr
                                        class="{{ $loop->index + 1 != count($users) ? 'border-b border-gray-100 dark:border-gray-800' : '' }}">
                                        ...
                                        <td class="px-5 py-4 sm:px-6 flex items-center md:min-w-[200px]">
                                            <a data-tooltip-target="tooltip-user-{{ $user->id }}"
                                                ...
                                                <img src="{{ ld_apply_filters('user_list_page_avatar_item', $user->getGravatarUrl(40), $user) }}"
                                                    alt="{{ $user->name }}" class="w-10 h-10 rounded-full mr-3">
                                                <div class="flex flex-col">
                                                    <span>{{ $user->name }}</span>
                                                    <span
                                                        class="text-xs text-gray-500 dark:text-gray-300">{{ $user->username }}</span>
                                                </div>
                                            </a>
                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            @foreach ($user->roles as $role)
                                                <span
                                                    class="capitalize inline-flex items-center justify-center px-2 py-1 text-xs font-medium text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
