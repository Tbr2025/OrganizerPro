...
<div class="p-4 mx-auto max-w-7xl md:p-6 lg:p-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
        ...
        <a href="{{ route('admin.tournaments.banners.index', $tournament) }}"
           class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-teal-500 transition text-center group">
            <div class="w-12 h-12 mx-auto mb-3 rounded-xl bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center group-hover:scale-110 transition">
                <svg class="w-6 h-6 text-teal-600 dark:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
            </div>
            <p class="font-semibold text-gray-900 dark:text-white text-sm">Banners / Ads</p>
        </a>
        ...
        <a href="{{ route('admin.tournaments.templates.generate', $tournament) }}"
           class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-green-500 transition text-center group">
            ...
            <p class="font-semibold text-gray-900 dark:text-white text-sm">Generate Poster</p>
        </a>
        @endif
    </div>
