...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl border border-emerald-200 dark:border-emerald-800 p-4">
        ...
        <div class="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-5 gap-3 text-sm">
            ...
            <div class="bg-white/60 dark:bg-gray-800/60 rounded-lg p-3">
                <span class="font-medium text-gray-900 dark:text-white">Fixtures Poster</span>
                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Upcoming match schedule with logos</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
        @php
            $typeIcons = [
                ...
                'fixtures_poster' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11v6m-3-3h6" />',
                'auction_poster' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />',
                'auction_poster_portrait' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />',
                'retained_welcome_card' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 9V7a5 5 0 0110 0v2" />',
            ];
            $typeColors = [
                'welcome_card' => 'from-blue-500 to-cyan-500',
                'retained_welcome_card' => 'from-purple-500 to-violet-500',
                ...
                'fixtures_poster' => 'from-teal-500 to-cyan-500',
                'auction_poster' => 'from-amber-500 to-orange-600',
                'auction_poster_portrait' => 'from-amber-500 to-orange-600',
            ];
        @endphp
