                ...
                <div id="tab-elements" class="tab-content">
                    <div class="sidebar-section">
                        ...
                        @foreach($placeholders as $placeholder)
                            @php $isImage = in_array($placeholder, ['player_image', 'team_logo', 'tournament_logo', 'team_a_logo', 'team_b_logo', 'team_a_captain_image', 'team_b_captain_image', 'man_of_the_match_image', 'winner_logo', 'qr_code']); @endphp
