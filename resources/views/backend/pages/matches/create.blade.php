    ...
    <div class="p-4 mx-auto max-w-4xl md:p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Create New Match</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Fill in the match details below</p>
                </div>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.matches.store') }}" class="space-y-6">
                        ...
                        {{-- Tournament Selection (First - determines teams) --}}
                            ...
                            <div>
                                ...
                                <select name="overs" id="overs"
                                    ...
                                    @foreach ([5, 6, 8, 10, 12, 15, 20, 50] as $over)
                                        <option value="{{ $over }}" @selected(old('overs') == $over)>{{ $over }} Overs</option>
                                    @endforeach
                                </select>
                                @error('overs')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
