...
<div class="p-4 mx-auto max-w-screen-xl md:p-6 space-y-6">
            ...
            <table class="w-full table-auto border text-sm">
                ...
                <tbody>
                    ...
                    <tr class="text-center border-b dark:border-gray-700">
                        ...
                        <td class="p-2">{{ $player->balls_faced > 0 ? round(($player->runs / $player->balls_faced) * 100, 2) : '0.00' }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="w-full table-auto border text-sm">
                ...
                <tbody>
                    ...
                    <tr class="text-center border-b dark:border-gray-700">
                        ...
                        <td class="p-2">{{ $player->overs_bowled > 0 ? round($player->runs_conceded / $player->overs_bowled, 2) : '0.00' }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div class="bg-gray-100 dark:bg-gray-800 p-4 rounded shadow-sm">
                ...
                @foreach($items as $item)
                    <p class="text-sm text-gray-700 dark:text-gray-300">{{ $item->player->name }} ({{ $item->player->team->name }})</p>
                @endforeach
            </div>
            @endforeach
        </div>
