...
@section('admin-content')
    {{-- Main wrapper with Alpine.js for checkbox selection --}}
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($players as $player)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/40">
                                @if (auth()->user()->hasAnyRole(['Superadmin', 'Admin']))
                                    <td class="p-4">
                                        <input type="checkbox" class="form-checkbox player-checkbox"
                                    ...
                                    <div class="space-y-1">
                                        <div class="flex items-center gap-2 text-gray-800 dark:text-gray-200">
                                            ...
                                            <a href="tel:{{ $player->mobile_number_full }}"
                                                class="hover:underline">+{{ $player->mobile_number_full }}</a>
                                        </div>
                                        @if ($player->cricheroes_number_full)
                                            <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                                ...
                                                <span>+{{ $player->cricheroes_number_full }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ auth()->user()->hasAnyRole(['Superadmin', 'Admin'])? '8': '6' }}"
