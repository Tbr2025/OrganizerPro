...
<div class="p-4 mx-auto max-w-7xl md:p-6">
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $players->count() }} approved players</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        @else
            <div class="p-8 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This team has no approved players yet.</p>
            </div>
        @endif
    </div>
...
<script>
    ...
    function openViewPlayerModal(playerId) {
        ...
        html += `<div><h4 class="text-xl font-bold text-gray-900 dark:text-white">${player.name}</h4></div></div>`;
