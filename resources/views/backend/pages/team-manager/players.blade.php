...
<div class="p-4 mx-auto max-w-7xl md:p-6">
    ...
    {{-- Quick filter tags, one labelled row per parameter. Click to apply, click
         again to remove. Counts cover every approved player matching the current
         search, not just this page. --}}
