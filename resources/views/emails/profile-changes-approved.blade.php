...
<head>
    ...
    <title>Profile changes approved</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: {{ $primaryColor }}; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
        ...
        <h1 style="color: #ffffff; margin: 0; font-size: 22px;">Profile Changes Approved</h1>
    ...
    <div style="background: #f8f9fa; padding: 30px; border: 1px solid #e9ecef; border-top: none;">
        ...
        <p style="margin: 0 0 16px 0;">Your profile change request has been <strong style="color: #059669;">approved</strong> and applied. Here's a summary of the updates:</p>

        <div style="background: white; border-radius: 8px; padding: 6px 16px; margin-bottom: 20px; border-left: 4px solid #059669;">
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                ...
                <tr style="border-top: 1px solid #eee;">
                    ...
                    <td style="padding: 10px 8px; font-weight: 600; color: #059669;">{{ $c['new'] === '' ? '—' : $c['new'] }}</td>
                </tr>
                @endforeach
            </table>
        </div>

        <p style="margin: 0; color: #6c757d; font-size: 13px;">If you did not request these changes, please contact the tournament organizer immediately.</p>
    </div>
